...
The policy {{< math >}}$\pi_\theta$ {{< /math >}} is the controller, the reward or evaluation model {{< math >}}$r_\phi$ {{< /math >}} defines the learning signal, and {{< math >}}$\mathcal{E}$ {{< /math >}} is the evaluation protocol that exposes distribution shift between training and deployment.
