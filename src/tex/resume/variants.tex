...
\newcommand{\cvmainbase}{%
  ...
  \renewcommand{\CVAnyThree}{Built RL training and evaluation pipelines for parallel simulation, multi-seed ablations, robustness studies, and reproducible policy comparisons.}
  \renewcommand{\CVAnyFour}{Secured and led a EuroHPC allocation of \EuroHPCAllocation{} for large-scale experiments on RL robustness, curriculum learning, and adaptive experience allocation.}
