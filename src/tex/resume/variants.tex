...
\newcommand{\cvmainbase}{%
  \renewcommand{\CVHeadline}{RESEARCH SCIENTIST {\enskip\cdotp\enskip} REINFORCEMENT LEARNING {\enskip\cdotp\enskip} ROBOT LEARNING {\enskip\cdotp\enskip} SEQUENTIAL DECISION-MAKING}
  \renewcommand{\CVSummary}{Research scientist in reinforcement, imitation, and reward learning, studying curriculum learning, adaptive data and task selection, and generalization under distribution shift in sequential decision-making. My work focuses on how the allocation and structure of training experience affect learned behavior, spanning learning from demonstrations, robust policy learning across heterogeneous environments and dynamics, and rare or safety-critical conditions. I combine algorithm development with large-scale GPU experimentation, systematic empirical evaluation, and deployment on physical robotic systems.}

  \renewcommand{\CVAnyOne}{Originated and led \PSCShortName{}, a method for reallocating training experience toward rare, safety-critical conditions using learned predictions of future safety cost; carried the project from research formulation through large-scale experimentation to production deployment and hardware validation.}
  \renewcommand{\CVAnyTwo}{Developed and deployed reinforcement-learning locomotion policies for industrial quadruped robots using Isaac Sim/IsaacLab, including sim-to-real evaluation across difficult terrain, observation perturbations, and hardware-relevant failure modes.}
  \renewcommand{\CVAnyThree}{PSC improved robustness across controlled simulation studies and reduced hardware shank-contact failures by \PSCRelativeResult{} on repeated ANYmal-D evaluations.}
  \renewcommand{\CVAnyFour}{Built GPU-scale training and evaluation infrastructure for thousands of parallel simulated environments, supporting multi-seed ablations, robustness studies, and reproducible policy comparisons.}
  \renewcommand{\CVAnyFive}{Secured and led a EuroHPC allocation of \EuroHPCAllocation{} for large-scale experiments on RL robustness, curriculum learning, and adaptive training distributions.}

  \renewcommand{\CVETHDisplayTitle}{Doctoral Researcher, Computer Science}
  \renewcommand{\CVETHOne}{Developed imitation and inverse reinforcement learning methods for learning from heterogeneous demonstrations, including reward objectives designed to generalize across dynamics and environment shifts.}
  \renewcommand{\CVETHTwo}{Developed distribution-matching objectives based on generalized sliced Wasserstein distances for imitation learning in continuous-control settings.}
  \renewcommand{\CVETHThree}{Built an RL benchmark for arthroscopic surgical training and applied inverse reinforcement learning to trainee evaluation and skill assessment.}
  ...
  \renewcommand{\CVSkillOneLabel}{Research}
  \renewcommand{\CVSkillOne}{Reinforcement learning \;\textbar\; imitation learning \;\textbar\; reward learning \;\textbar\; curriculum learning \;\textbar\; adaptive task selection \;\textbar\; robust learning under distribution shift}
  \renewcommand{\CVSkillTwoLabel}{Generative \& sequential models}
  \renewcommand{\CVSkillTwo}{Diffusion and flow matching \;\textbar\; representation learning \;\textbar\; sequential generative modeling}
  \renewcommand{\CVSkillThreeLabel}{Systems \& simulation}
  \renewcommand{\CVSkillThree}{PyTorch, JAX \;\textbar\; distributed/GPU training \;\textbar\; Isaac Sim/IsaacLab, MuJoCo, ROS/ROS 2}
...
\cvapplyvariant{meta_rl_research}{\cvmainbase
  \renewcommand{\CVHeadline}{RESEARCH ENGINEER {\enskip\cdotp\enskip} REINFORCEMENT LEARNING {\enskip\cdotp\enskip} ROBOT LEARNING {\enskip\cdotp\enskip} SEQUENTIAL DECISION-MAKING}
  \renewcommand{\CVSummary}{Research engineer in reinforcement, imitation, and reward learning, studying curriculum learning, adaptive data and task selection, and generalization under distribution shift in sequential decision-making. My work focuses on how the allocation and structure of training experience affect learned behavior, spanning learning from demonstrations, robust policy learning across heterogeneous environments and dynamics, and rare or safety-critical conditions. I combine algorithm development with large-scale GPU experimentation, systematic empirical evaluation, and deployment on physical robotic systems.}
  \renewcommand{\CVSkillThreeLabel}{Robotics \& systems}
  \renewcommand{\CVSkillThree}{PyTorch, JAX \;\textbar\; distributed/GPU training \;\textbar\; Isaac Sim/IsaacLab, MuJoCo, ROS/ROS 2 \;\textbar\; sim-to-real and real-robot policy deployment}
}
